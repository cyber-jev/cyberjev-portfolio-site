...
const Loader: React.FC = () => {
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="animate-spin rounded-full h-10 w-10 md:h-16 md:w-16 border-t-4 border-b-4 border-accent">
        {" "}
      </div>
...
const LoaderComponent: React.FC<LoaderComponentProps> = ({ children }) => {
  ...
  return (
    <div className="bg-bg-body m-auto transition-all transform ease-in-out">
